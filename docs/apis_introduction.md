...
* **Web API**: [REST](./rest/rest.md) and also [REST-like](./rest/restlike-web-services.md). System behaviour is based on transitions of data (or _resources_, as called in HTTP).
* **RPC API**: [gRPC](./grpc/grpc.md), JSON-RPC, SOAP or XML-RPC.
